...
/****************************************************************************\
 CHZColor: Repräsentiert einen Farbwert
\****************************************************************************/
class CHZColor
{
public:
	...
	// ----------------------
	CHZColor(COLORREF cr = black);
	CHZColor(CHZColor* pColor);
	operator COLORREF() const;
	CHZColor& operator =(const COLORREF cr);
	CHZColor& operator =(CHZColor col);
	...
	bool Brighten(float fVal);
	float* GetLab();

	float GetLabLuminance();
	void SetLabLuminance(float l_s);

	float m_fCompare;
	static int CompareColor(const void* col1, const void* col2);
	...
	CString GetNearestName() const; // Liefert String mit benannter Farbe oder #RRGGBB falls kein Name bekannt

	static CHZColor FromString(LPCTSTR pcColor); 
	static LPCTSTR GetNameFromIndex(int i);
	static CHZColor GetColorFromIndex(int i);
	static int		GetNumNames() {return numNamedColors;}
	static CHZColor GetHeatmapColor(float fValue);
